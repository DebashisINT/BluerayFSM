package com.bluerayfsm.features.logoutsync.presentation
...
import com.bluerayfsm.app.AppDatabase
...
import com.bluerayfsm.app.utils.AppUtils
import com.bluerayfsm.app.utils.Toaster
import com.bluerayfsm.base.BaseResponse
import com.bluerayfsm.base.presentation.BaseActivity
import com.bluerayfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.bluerayfsm.features.billing.api.AddBillingRepoProvider
import com.bluerayfsm.features.billing.model.AddBillingInputParamsModel
...
import com.bluerayfsm.features.dashboard.presentation.ReasonDialog
...
import com.bluerayfsm.features.document.model.AddEditDocumentInputParams
import com.bluerayfsm.features.document.model.DocumentAttachmentModel
...
import com.bluerayfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.bluerayfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.bluerayfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.bluerayfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.bluerayfsm.features.orderhistory.model.*
...
import com.bluerayfsm.features.quotation.model.AddQuotInputModel
import com.bluerayfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.bluerayfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.bluerayfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.bluerayfsm.features.stock.api.StockRepositoryProvider
import com.bluerayfsm.features.stock.model.AddStockInputParamsModel
import com.bluerayfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.bluerayfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.bluerayfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.bluerayfsm.features.timesheet.model.AddTimeSheetInputModel
import com.bluerayfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.bluerayfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.bluerayfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.bluerayfsm.mappackage.SendBrod
import com.bluerayfsm.widgets.AppCustomTextView
import com.bluerayfsm.MonitorService
import com.bluerayfsm.MySingleton
import com.bluerayfsm.features.addshop.model.*
import com.bluerayfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.bluerayfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.bluerayfsm.features.login.model.GetConcurrentUserResponse
import com.bluerayfsm.features.login.model.WhatsappApiData
import com.bluerayfsm.features.performance.model.Gps_status_list
import com.bluerayfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.bluerayfsm.features.returnsOrder.ReturnProductList
import com.bluerayfsm.features.returnsOrder.ReturnRequest
import com.bluerayfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbluerayfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbluerayfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbluerayfsmlogsample/log.zip").path);
